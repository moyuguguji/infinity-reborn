onEvent('recipes', event => {
    ...
    event.shapeless('ringsofascension:ring_fire_resistance', ['gobber2:gobber2_ring_nether','things:hades_crystal'])
    ...
    event.shaped('ringsofascension:ring_invisibility', [
      ...
      event.shapeless('ringsofascension:ring_strength', ['gobber2:gobber2_ring_nether',Item.of('mcdw:sword_heartstealer').ignoreNBT(),Item.of('gobber2:gobber2_sword').ignoreNBT()])
