onEvent('recipes', event => {
	Ingredient.of('#c:armor').getItemIds().forEach(element => {
        event.smithing(Item.of(element).withNBT('{Tiered:{Tier:"tiered:unique_armor"},saa1:{MAX_HEALTH:{bonusMaxHP:10f}}}'), 'kubejs:upgrade_life', Item.of(element).ignoreNBT())
		...
		event.smithing(Item.of(element).withNBT('{Tiered:{Tier:"tiered:unique_armor"},saa1:{DMG_REDUCTION:{dmgReduc:20f},MAX_HEALTH:{bonusMaxHP:20f}}}'), 'kubejs:upgrade_nami', Item.of(element).ignoreNBT())
    });
