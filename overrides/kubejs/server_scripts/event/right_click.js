...
const rightClickEventMainHand = {
	...
	'kubejs:yong_hen_star': function(event) {
		...
		if (player.getHeldItem(OFF_HAND) != null) {
			...
			let yonghen = [
				Item.of('mcda:cave_crawler_helmet', '{Damage:0,Tiered:{Tier:"tiered:epic_armor"},durable:0.3d}'),
				Item.of('mcda:cave_crawler_chestplate', '{Damage:0,Tiered:{Tier:"tiered:epic_armor"},durable:0.3d}'),
				Item.of('mcda:cave_crawler_leggings', '{Damage:0,Tiered:{Tier:"tiered:epic_armor"},durable:0.3d}'),
				Item.of('mcda:cave_crawler_boots', '{Damage:0,Tiered:{Tier:"tiered:epic_armor"},durable:0.3d}'),
				Item.of('inmis:bejeweled_backpack', '{Inventory:[{Slot:0,Stack:{Count:1b,id:"toms_storage:ts.inventory_connector"}},{Slot:1,Stack:{Count:1b,id:"toms_storage:ts.crafting_terminal"}},{Slot:2,Stack:{Count:3b,id:"expandedstorage:diamond_barrel"}},{Slot:3,Stack:{Count:1b,id:"mcdw:sword_iron_sword_var",tag:{Damage:0,Tiered:{Tier:"tiered:legendary"},durable:0.15d,swa3:{}}}},{Slot:4,Stack:{Count:16b,id:"things:recall_potion"}},{Slot:5,Stack:{Count:1b,id:"things:socks",tag:{Tiered:{Tier:"tiered:warding",hash:617978927}}}},{Slot:6,Stack:{Count:1b,id:"extraalchemy:potion_bag",tag:{}}},{Slot:7,Stack:{Count:8b,id:"minecraft:golden_apple"}},{Slot:8,Stack:{Count:10b,id:"kubejs:bandage"}},{Slot:9,Stack:{Count:1b,id:"nomadbooks:nomad_book",tag:{nomadbooks:{Height:8,Structure:"nomadbooks:campfire3x1x3",Upgrades:["fungi_support","aquatic_membrane"],Width:13}}}},{Slot:10,Stack:{Count:1b,id:"piercingpaxels:diamond_paxel",tag:{Damage:0,Tiered:{Tier:"tiered:legendary_multi_tool"},durable:0.5d}}},{Slot:11,Stack:{Count:16b,id:"kubejs:ametrine_crystal"}},{Slot:12,Stack:{Count:5b,id:"kubejs:crystal_tiered"}},{Slot:13,Stack:{Count:10b,id:"kubejs:skill_bottle"}},{Slot:14,Stack:{Count:6b,id:"waystones:sharestone"}},{Slot:15,Stack:{Count:1b,id:"museumcurator:museumchecklist"}},{Slot:16,Stack:{Count:1b,id:"kubejs:disintegration_tablet"}},{Slot:17,Stack:{Count:1b,id:"minecraft:smithing_table"}},{Slot:18,Stack:{Count:1b,id:"minecraft:anvil"}},{Slot:19,Stack:{Count:1b,id:"dankstorage:dock"}},{Slot:20,Stack:{Count:1b,id:"minecraft:air"}},{Slot:21,Stack:{Count:1b,id:"minecraft:air"}},{Slot:22,Stack:{Count:1b,id:"minecraft:air"}},{Slot:23,Stack:{Count:1b,id:"minecraft:air"}},{Slot:24,Stack:{Count:1b,id:"minecraft:air"}},{Slot:25,Stack:{Count:1b,id:"minecraft:air"}},{Slot:26,Stack:{Count:1b,id:"minecraft:air"}},{Slot:27,Stack:{Count:1b,id:"minecraft:air"}},{Slot:28,Stack:{Count:1b,id:"minecraft:air"}},{Slot:29,Stack:{Count:1b,id:"minecraft:air"}},{Slot:30,Stack:{Count:1b,id:"minecraft:air"}},{Slot:31,Stack:{Count:1b,id:"minecraft:air"}},{Slot:32,Stack:{Count:1b,id:"minecraft:air"}},{Slot:33,Stack:{Count:1b,id:"minecraft:air"}},{Slot:34,Stack:{Count:1b,id:"minecraft:air"}},{Slot:35,Stack:{Count:1b,id:"minecraft:air"}},{Slot:36,Stack:{Count:1b,id:"minecraft:air"}},{Slot:37,Stack:{Count:1b,id:"minecraft:air"}},{Slot:38,Stack:{Count:1b,id:"minecraft:air"}},{Slot:39,Stack:{Count:1b,id:"minecraft:air"}},{Slot:40,Stack:{Count:1b,id:"minecraft:air"}},{Slot:41,Stack:{Count:1b,id:"minecraft:air"}},{Slot:42,Stack:{Count:1b,id:"minecraft:air"}},{Slot:43,Stack:{Count:1b,id:"minecraft:air"}},{Slot:44,Stack:{Count:1b,id:"minecraft:air"}}]}')
			]
