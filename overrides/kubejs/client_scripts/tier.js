onEvent('item.tooltip', tooltip => {
  ...
  tooltip.addAdvanced([
    ...
    text.add(1, Text.white('✦·常见').bold(true))
  })
  tooltip.addAdvanced([
    ...
    'mythicmetals:celestium_sword','spirit:soul_steel_sword','spectrum:looting_falchion','twilightforest:ice_sword',
  ...
  tooltip.addAdvanced([
    ...
    text.add(1, Text.green('✦✦✦·极品').bold(true))
  })
  tooltip.addAdvanced([
    ...
    text.add(1, Text.gold('✦✦✦✦·圣物（可转生）').bold(true))
  })
  tooltip.addAdvanced([
    ...
    text.add(1, Text.red('✦✦✦✦✦·神器（可转生）').bold(true))
  })
  ...
  tooltip.addAdvanced([
    ...
    'mcdw:crossbow_shadow_crossbow','mcdw:crossbow_slayer_crossbow','mcdw:crossbow_soul_hunter_crossbow','gobber2:gobber2_bow'
  ], (item, advanced, text) => {
    text.add(1, Text.green('✦✦✦·极品').bold(true))
  })
  tooltip.addAdvanced([
    'mcdw:crossbow_baby_crossbow','mcdw:crossbow_corrupted_crossbow','mcdw:crossbow_doom_crossbow','twilightforest:ice_bow',
    'twilightforest:ender_bow','gobber2:gobber2_bow_nether'
  ], (item, advanced, text) => {
    text.add(1, Text.gold('✦✦✦✦·圣物').bold(true))
  })
  tooltip.addAdvanced([
  ...
  tooltip.addAdvanced([
    'mcda:sturdy_shulker_armor_helmet','mcda:sturdy_shulker_armor_chestplate',
    'mcda:sturdy_shulker_armor_leggings','mcda:sturdy_shulker_armor_boots',
    'gobber2:gobber2_helmet_end','gobber2:gobber2_chestplate_end',
    'gobber2:gobber2_leggings_end','gobber2:gobber2_boots_end',
    'gobber2:gobber2_helmet_dragon','gobber2:gobber2_chestplate_dragon',
    'gobber2:gobber2_leggings_dragon','gobber2:gobber2_boots_dragon',
    'spectrum:bedrock_helmet','spectrum:bedrock_chestplate',
    'spectrum:bedrock_leggings','spectrum:bedrock_boots',
    'dragonloot:dragon_helmet','dragonloot:dragon_chestplate',
    'dragonloot:dragon_leggings','dragonloot:dragon_boots','dragonloot:upgraded_dragon_chestplate'
  ], (item, advanced, text) => {
    text.add(1, Text.red('✦✦✦✦✦·神器（可转生）').bold(true))
  })
