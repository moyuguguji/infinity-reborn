...
execute as @s at @s positioned ~ ~1.5 ~ if block ~ ~ ~ #astral_infection:sand_shark_swimables run function wormai:ai/bounce/sand2
execute as @s at @s unless block ~ ~1.5 ~ #astral_infection:sand_shark_swimables run tp @s ^ ^0.05 ^0.5 facing ^ ^ ^-1
