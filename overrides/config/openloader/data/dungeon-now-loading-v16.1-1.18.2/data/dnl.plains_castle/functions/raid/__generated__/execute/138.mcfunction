...
execute if score @s dnl.difficulty matches ..5 run bossbar set dnl.raidbar1 color green
execute if score @s dnl.difficulty matches 6..7 run bossbar set dnl.raidbar1 color red
execute if score @s dnl.difficulty matches 8.. run bossbar set dnl.raidbar1 color purple
