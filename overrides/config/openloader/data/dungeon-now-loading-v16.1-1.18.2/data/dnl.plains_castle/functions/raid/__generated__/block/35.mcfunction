...
execute as @e[type=#dnl.lib:mobs,dx=20,dy=13,dz=20,tag=dnl.raid_mob] at @s run function dnl.plains_castle:raid/__generated__/block/36
title @a[dx=20,dy=13,dz=20] actionbar {"text":"Time's Up!","color":"red","italic":false}
