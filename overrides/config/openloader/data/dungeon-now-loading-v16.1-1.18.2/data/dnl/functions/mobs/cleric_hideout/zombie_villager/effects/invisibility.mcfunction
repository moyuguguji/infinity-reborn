...
execute if score @s dnl.timer matches 1 run data merge entity @s {HandItems:[{id:"minecraft:potion",Count:1b,tag:{Potion:"minecraft:invisibility"}},{}]}
...
execute if score @s dnl.timer matches 30 run tag @s remove dnl.invisibility
